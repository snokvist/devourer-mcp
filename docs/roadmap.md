...
37 MCP tools across DISCOVER / OBSERVE / INSPECT / TRANSMIT / EXPERIMENT /
CHARACTERIZE / BUILD TOOL. 213 offline tests plus 63 vendored Devourer
...
| `devourer-bridge` | done | separate process, protocol v1.10, session ownership |
...
**The bridge calls 29 of `IRadio`'s 55 virtual methods.** That single number is
...
- **Bridge protocol versioning.** v1.10 with a major-version gate. No
